...
### 2-1. 이 저장소 페이지에서 Fork 클릭

이 페이지 오른쪽 위에 있는 **Fork** 버튼을 클릭합니다.

![Fork 버튼 위치](images/step2-1-fork-button.png)
...
![Fork 화면에서 이름 변경](images/step2-2-create-fork.png)
...
![완성된 포트폴리오 페이지](images/step3-1-pages-live.png)
...
![index.html 파일에서 연필 아이콘 클릭](images/step4-1-edit-file.png)
...
![편집 모드와 Commit changes 버튼](images/step4-2-editing.png)
